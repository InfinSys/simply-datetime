...
#define SIMPLYDT_LIB_ABSTRACT_DAP_DRIVER_TAG_H_

/*!
 * @namespace simplydt::dap
 *
 * @brief
 * Datetime Abstraction Protocol.
 */
namespace simplydt::dap
{
    ...
    /*!
     * @brief
     * Abstract DAP driver tag.
     */
    struct AbstractDAPDriver { };

} // namespace simplydt::dap

#endif // SIMPLYDT_LIB_ABSTRACT_DAP_DRIVER_TAG_H_
